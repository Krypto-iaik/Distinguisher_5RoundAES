...
#define NUMBER_CP 256 //Don't change this number
#define N_TEST 2
/* About N_Repetitions:
...
void subspaceTest(word8 key[][4], int modeOfOperation)
{
        ...
        for(coset = 0; coset < 4; coset++)
        {
		    ...
		    //cost of the distinguisher
                    ...
                    if(superFlag == 1)
                    {
                        ...
                        printf("Number of Look-ups: %f - Theoretical: 20480 = 2^14.3 \n", numberTableLook);
                        if(modeOfOperation == 0)
                            printf("\n Something WRONG...\n");
                        else
                            printf("\n Right Result!\n");
    ...
    if(modeOfOperation == 1)
        printf("\n Something WRONG: USE an HIGHER NUMBER OF TEXTS!!!\n");
    else
        printf("\n Right Result!\n");
...
/**The program verifies the differential structural distinguisher on 4-round small-scale AES.
...
int main()
{
    ...
    printf("DIFFERENTIAL STRUCTURAL DISTINGUISHER on 4-Round Reduced (Small Scale) AES.\n\n");
    printf("The program verifies the distinguisher proposed in Sect. 5 on small scale AES.");
